...
class DeepSort(object):
    def __init__(self, model_path, max_dist=0.35, min_confidence=0.3, nms_max_overlap=1.0, max_iou_distance=0.8, max_age=125, n_init=3, nn_budget=100, use_cuda=True):
